...
class Vision(Auth):
    ...
    def detect_text(self, image_path: str) -> (Tuple[Image.open, list]):
        ...
        for block in texts.pages[0].blocks:
            ...
            canvas.rectangle([coord1, coord2], fill=image.getpixel((coord1[0] + 10, coord1[1])))
...
if __name__ == '__main__':
    vision = Vision(service_account=r'E:\Users\alexa\Documents\GCP\manga.json')
    print(vision.detect_text(r'E:\Users\alexa\Documents\scripts\desktop\sync-nhentai\18794\6.png'))